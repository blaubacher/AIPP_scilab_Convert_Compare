...
// Modified 2/8/24 for Heat Transfer
//
//  AIPP deck file translator to JSON input deck for AIPP-3
//
// mod 10/11/23, change 'amount' field to integers for wafers and grains
//
clear
...
pi=3.1415926;
folderinfo =dir()
rows.aipp235 = grep(folderinfo.name, ".deck")
...
"heat_transfer_coefficient", "viscous_flow_factor","scale_factor"]
